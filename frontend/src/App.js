...
const BuyNFTModal = ({ isOpen, onClose, nftSettings }) => {
  ...
  // Settings from admin or defaults
            ...
            <div className="relative flex items-center gap-4 mb-2">
              ...
              <div>
                <h2 className="text-xl font-bold">
                  {language === 'ru' ? 'NFT Боксы FOMO' : 'FOMO NFT Boxes'}
                </h2>
                <p className="text-white/80 text-sm">
                  {language === 'ru' ? `${TOTAL_SUPPLY} уникальных боксов` : `${TOTAL_SUPPLY} unique boxes`}
                </p>
              </div>
            </div>
          </div>
            ...
            {step === 'select' && (
              <>
                <p className="text-gray-600 text-sm mb-6">
                  {language === 'ru' 
                    ? 'Приобретите NFT бокс и станьте частью экосистемы FOMO. Каждый бокс содержит уникальные награды и привилегии.'
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-emerald-800 font-medium text-sm">
                        {language === 'ru' ? 'Специальное предложение' : 'Special Offer'}
                      </p>
                      <p className="text-emerald-600 text-xs">
                        {language === 'ru' 
                          ? `Скидка ${DISCOUNT_PERCENT}% при покупке от ${DISCOUNT_THRESHOLD} боксов`
                ...
                <div className="mb-6">
                  <label className="block text-gray-700 text-sm font-medium mb-2">
                    {language === 'ru' ? 'Количество боксов' : 'Number of boxes'}
                  </label>
                  <div className="flex items-center gap-3">
                    <button 
                ...
                <div className="bg-gray-50 rounded-xl p-4 mb-6 space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">
                      {language === 'ru' ? 'Цена за бокс' : 'Price per box'}
                    </span>
                  ...
                  {hasDiscount && (
                    <div className="flex justify-between text-sm text-emerald-600">
                      <span>{language === 'ru' ? `Скидка ${DISCOUNT_PERCENT}%` : `${DISCOUNT_PERCENT}% Discount`}</span>
                ...
                >
                  {language === 'ru' ? 'Купить NFT боксы' : 'Buy NFT Boxes'}
                </button>
                
                <p className="text-center text-gray-400 text-xs mt-4">
                  {language === 'ru' 
                    ? 'Подключите кошелёк для завершения покупки'
            ...
            {step === 'processing' && (
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
                  {language === 'ru' ? 'Обработка транзакции...' : 'Processing transaction...'}
                </h3>
            ...
            {step === 'success' && (
              <div className="text-center py-6 relative overflow-hidden">
                ...
                <p className="text-gray-600 mb-4">
                  {language === 'ru' 
                    ? `Вы успешно приобрели ${quantity} NFT ${quantity === 1 ? 'бокс' : quantity < 5 ? 'бокса' : 'боксов'} FOMO!`
                ...
                <p className="text-sm text-gray-500 mb-4">
                  {language === 'ru' 
                    ? 'Ваши NFT боксы будут доступны в кошельке после подтверждения транзакции.'
